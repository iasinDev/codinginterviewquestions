...
def ClosestXdestinations(numDestinations, allLocations, numDeliveries):
    return sorted(allLocations, key = lambda loc: math.sqrt(loc[0]**2+loc[1]**2))[:numDeliveries]

print(ClosestXdestinations(3, [[1,2], [3,4], [1,-1]],2) == [[1, -1], [1, 2]])
print(ClosestXdestinations(6, [[3,6], [2,4], [5,3], [2,7], [1,8], [7,9]],3) == [[2, 4], [5, 3], [3, 6]])
